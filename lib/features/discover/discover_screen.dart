...
class _DiscoverScreenState extends State<DiscoverScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print(width);
    /*MediaQuery size 말고도 다양하게 알려줌.
    MediaQuery.of(context).size 
    MediaQuery.of(context).padding; 
    MediaQuery.of(context).orientation; -- direction
    MediaQuery.of(context).platformBrightness -- dark mode/ bright mode
     */
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: ConstrainedBox(
            // Container가라면 굳이 ConstrainedBox 안써도됨. 자체적으로 cosntraitns property 갖고있음
            // Container 로감싸면 decoraton property 같은 것도 있으므로, 
          ...
          children: [
            ...
            GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: width > Breakpoints.lg ? 5 : 2, //# of columns
              ...
              //columb 갯수가 crossAxiscount에서 width 기준으로 나뉘는데
              // columb 자체적인 크기로 DefaultText 부분을 보이게할수도있고 아닐수도 있다는 점에서 LayoutBuilder가 사용되면 좋음
